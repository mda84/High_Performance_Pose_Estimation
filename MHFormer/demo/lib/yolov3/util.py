...
def write_results(prediction, confidence, num_classes, nms=True, nms_conf=0.4, det_hm=False):
    ...
    #print("THIIIIISSSSS",prediction[:,:,4])
    ...
    '''box_a[:, :, 0] = np.maximum(prediction[:, :, 0] - prediction[:, :, 2]/2, np.zeros_like(prediction[:, :, 0]))
    box_a[:, :, 1] = np.maximum(prediction[:, :, 1] - prediction[:, :, 3]/2, np.zeros_like(prediction[:, :, 1]))
    box_a[:, :, 2] = np.minimum(prediction[:, :, 0] + prediction[:, :, 2]/2, np.ones_like(prediction[:, :, 0]))
    box_a[:, :, 3] = np.minimum(prediction[:, :, 1] + prediction[:, :, 3]/2, np.ones_like(prediction[:, :, 1]))'''
